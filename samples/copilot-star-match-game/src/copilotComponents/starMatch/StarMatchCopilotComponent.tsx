...
import type { IStarMatchProps } from './components/IStarMatchProps';
import type { IStarMatchCopilotComponentProperties } from './StarMatchCopilotComponentProperties';

import * as strings from 'StarMatchCopilotComponentStrings';
 ...
 */
export default class StarMatchCopilotComponent extends BaseCopilotComponent<IStarMatchCopilotComponentProperties> {
